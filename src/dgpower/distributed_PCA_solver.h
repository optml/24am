...
template<typename F>
void distributed_sparse_PCA_solver(F * B, double *x, MDESC descB,
		int nnz_x, MKL_INT ictxt, MKL_INT ROW_BLOCKING,
		MKL_INT X_VECTOR_BLOCKING, solver_structures::optimization_settings* settings,
...
int distributed_pca_solver_from_two_dim_files(int MAP_X,
